<?php
    ...
    if(isset($_REQUEST['major']))
    {
        ...
        if($major == "computerengineering")
        {
            if($minor == "Maths")
            {
                header("Location: /cseng-major-math-minor");
            }
            if($minor == "Physics")
            {
                header("Location: /cseng-major-phy-minor");
            }
            if($minor == "Accounting")
            {
                header("Location: /csengr-major-Acc-minor");
            }
            if($minor == "Statistics")
            {
                header("Location: /csengr-major-Stat-minor");
            }
            if($minor == "No-minor")
            {
                header("Location: /only-cseng-major");
            }
        }
        if($major == "cybersecurity")
        {
