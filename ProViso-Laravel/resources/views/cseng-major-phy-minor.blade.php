...
<html>
    <head>
        ...
        <link rel="stylesheet" href="CSS/cseng-major-phy-minor.css">
    </head>
    <body class="banner">
        <div>
            <div class="navbar">
            ...
            <div class="card">
			<h1 class="card-header"> Major:CS-Engr Minor:Physics</h1>
            <div class="card-body">
	<h2>Freshman </h2>
	<h2>Sophomore</h2>
    <h2>Junior</h2>
...
$sql = " SELECT * FROM classes WHERE class_id IN ('ALL','CE','M_PHYS') ";
