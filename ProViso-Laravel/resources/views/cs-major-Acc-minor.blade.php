...
<html>
    <head>
        ...
        <link rel="stylesheet" href="CSS/cs-major-Acc-minor.css">
    </head>
    <body class="banner">
        <div>
            <div class="navbar">
            ...
            <div class="card">
			<h1 class="card-header"> Major:CS Minor:Accounting</h1>
            <div class="card-body">
	<!--h2>Freshman </h2>
	<h2>Sophomore</h2>
    <h2>Junior</h2>
...
$sql = " SELECT * FROM classes WHERE class_id IN ('ALL','CS','M_ACCT') ";
