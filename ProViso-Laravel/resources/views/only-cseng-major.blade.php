...
<html>
    <head>
        ...
        <link rel="stylesheet" href="CSS/only-cseng-major.css">
    </head>
    <body class="banner">
        <div>
            <div class="navbar">
            ...
            <div class="card">
			<h1 class="card-header"> Major:CS-Engr Minor:None</h1>
            <div class="card-body">
	<!--h2>Freshman </h2>
	<h2>Sophomore</h2>
    <h2>Junior</h2>
...
// SQL query to select data from database table classes for only computer engineering
$sql = " SELECT * FROM classes WHERE class_id LIKE 'CE%' OR class_id LIKE 'ALL%' ";
